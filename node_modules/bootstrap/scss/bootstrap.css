...
.btn-purple-dark {
  color: #fff;
  background: #260054 linear-gradient(180deg, #47266e, #260054) repeat-x;
  border-color: #260054;
  box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075); }
  .btn-purple-dark:hover {
    color: #fff;
    background: #15002e linear-gradient(180deg, #38264d, #15002e) repeat-x;
    border-color: #0f0021; }
  .btn-purple-dark:focus, .btn-purple-dark.focus {
    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.15), 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(38, 0, 84, 0.5); }
  ...
  .btn-purple-dark:not(:disabled):not(.disabled):active, .btn-purple-dark:not(:disabled):not(.disabled).active, .show > .btn-purple-dark.dropdown-toggle {
    ...
    .btn-purple-dark:not(:disabled):not(.disabled):active:focus, .btn-purple-dark:not(:disabled):not(.disabled).active:focus, .show > .btn-purple-dark.dropdown-toggle:focus {
      box-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125), 0 0 0 0.2rem rgba(38, 0, 84, 0.5); }
...
.btn-outline-purple-dark {
  ...
  .btn-outline-purple-dark:focus, .btn-outline-purple-dark.focus {
    box-shadow: 0 0 0 0.2rem rgba(38, 0, 84, 0.5); }
...
.badge-purple-dark {
  color: #fff;
  background-color: #260054; }
  .badge-purple-dark[href]:hover, .badge-purple-dark[href]:focus {
    color: #fff;
    text-decoration: none;
    background-color: #0f0021; }
...
.alert-purple-dark {
  color: #14002c;
  background: #d4ccdd linear-gradient(180deg, #dad4e2, #d4ccdd) repeat-x;
  border-color: #c2b8cf; }
  .alert-purple-dark hr {
    border-top-color: #b5a9c5; }
...
.bg-purple-dark {
  background-color: #260054 !important; }

a.bg-purple-dark:hover, a.bg-purple-dark:focus,
button.bg-purple-dark:hover,
button.bg-purple-dark:focus {
  background-color: #0f0021 !important; }
...
.bg-gradient-purple-dark {
  background: #260054 linear-gradient(180deg, #47266e, #260054) repeat-x !important; }
